...
#Here, the "big" loop starts - in the end, the user can choose if he wants to restart the program. If he chooses 'yes', it will start again from here
run_again = ("yes")
while run_again == ("yes"):    
    ...
    while True:
        ...
        try:
            #here, we perform a check if the date was entered in the correct format
      ...
      #here is the second, "small" loop (inside the big one)  - if the user wants to change the SMI company before proceeding, he has the chance to do so here. 
    run_again1 = ("no")
    while run_again1 == ("no"):    
...
#chart for the selected company within the chosen time will be illustrated
